...
<div>
    ...
    <div class="resource_details">
        ...
        <div class="title_container">
            <div>
			  <p style="font-weight:bold; color: gray;" id="internalAPI"></p>
			</div>
        ...
        <div class="description_and_url_container">
            ...
            <div class="url_container">
                <p data-role="method_url_container">
                    {{#if baseUrl}}
                    <span id="base_url" data-role="host">{{baseUrl}}</span>{{/if}}{{#if path}}
                    <span data-role="path">{{path}}</span>
...
<div class="row">
    <div class="col-sm-12">
        <div>
            <div id="path-param-list"> </div>
            <div id="query-param-list"> </div>
           <div id="header-param-list"> </div>
            <div id="body-param-list"> </div>
            {{#body}}
            {{#if attachments}}
...
<script type="text/javascript">
    ...
    function isAPIProxyEndPoint(basePath) {
        const listOFAPIProxiesBasePaths = [
            'http://staging.api.247-inc.net',
            'http://api.247-inc.net',
            'http://dev.api.247-inc.net',
            'http://qa.api.247-inc.net',
            'http://psr.api.247-inc.net',
            'http://stable.api.247-inc.net',
            'http://internal.api.248-inc.net',
            'http://dev.api.sv2.247-inc.net',
            'http://psr.api.sv2.247-inc.net',
            'http://qa.api.sv2.247-inc.net',
            'http://stable.api.sv2.247-inc.net',
            'https://staging.api.247-inc.net',
            'https://api.247-inc.net',
            'https://dev.api.247-inc.net',
            'https://qa.api.247-inc.net',
            'https://psr.api.247-inc.net',
            'https://stable.api.247-inc.net',
            'https://internal.api.248-inc.net',
            'https://dev.api.sv2.247-inc.net',
            'https://psr.api.sv2.247-inc.net',
            'https://qa.api.sv2.247-inc.net',
            'https://stable.api.sv2.247-inc.net'
        ]

        for (var index in listOFAPIProxiesBasePaths) {
            if (basePath.startsWith(listOFAPIProxiesBasePaths[index])) {
                return true;
            }
        }
        return false;
    ...
    function getBasePath() {
        return jQuery('#base_url').text()
    }
    if (isAPIProxyEndPoint(getBasePath())){
       newAuth.push('API Key');
    } else {
       newAuth.push('HTTP Basic');
    }
